    ...
    return (
        <>
            <HeaderTicket
                ...
                btn_url="https://chk.eduzz.com/hzvlt7qw"
                title="Guia de Intercorrência com conhecimento prático de +20 anos de experiência para você ter segurança na atuação como enfermeira"
                subtitle={<>Na faculdade, nos ensinam muita teoria, mas e na prática? Este Guia vai te mostrar <strong>todo o passo a passo</strong> para você saber <strong>executar com segurança</strong> a Avaliação Inicial, Secundária e a Abordagem Sistemática</>}
            />
            <main className="">
                ...
                <Section classNameS="px-4 py-12 sm:py-24 bg-[#000] grad-01">
                    <div className="flex flex-col gap-6 sm:gap-12">
                        <div className="w-full flex flex-col items-center gap-6">
                            ...
                            <div className="flex flex-col items-center gap-6 bg-[#33678c] border-8 border-[#608c98]/60 w-full max-w-xl py-12 px-4 sm:p-16 rounded-xl">
                                ...
                                <div className="flex flex-col text-center">
                                    ...
                                    <p className="text-5xl font-bold text-white">R$19,00</p>
                                </div>
