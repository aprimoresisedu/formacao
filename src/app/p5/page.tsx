                        ...
                        <div className="w-full flex flex-col items-center gap-6">
                            ...
                            <div className="flex flex-col items-center gap-6 bg-[#33678c] border w-full max-w-xl py-12 px-4 sm:p-16 rounded-xl">
                                ...
                                <ul className="flex flex-col gap-4">
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span><strong>E-Book: Guia de Intercorrência Segura</strong> para enfermeiras</span>
                                    </li>
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span><strong>ABCDE</strong> para não deixar nenhum paciente grave passar</span>
                                    </li>
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span><strong>Mnemônico MOVE</strong> para você tomar sempre a melhor decisão </span>
                                    </li>
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span><strong>Estratificação de risco</strong> para avaliar eventos adversos cardiovasculares (como IAM e AVC)</span>
                                    </li>
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span>Histórico <strong></strong> para sistematizar a solução de problemas</span>
                                    </li>
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span><strong></strong> para antecipação e organização de equipe</span>
                                    </li>
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span><strong>Checklist</strong> de funções, ações dos profissionais e recursos do setor</span>
                                    </li>
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span><strong>Exercícios</strong> com resposta para fixação prática do conteúdo</span>
                                    </li>
                                    <li className="relative ps-8 text-white">
                                        <svg className="h-6 w-6 absolute top-[1px] left-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                        </svg>
                                        <span><strong>7 aulas bônus</strong> para facilitar a aplicação do Guia no seu dia a dia</span>
                                    </li>
                                </ul>
