    ...
    >
      <div className="overflow-hidden w-full rounded-xl">
        <button
          ...
          className={`relative cursor-pointer p-2 sm:p-4 text-left w-full bg-[#101010] bg-client-pallet-2 font-medium rounded-xl ${isDropdownActived && 'rounded-b-none'} flex flex-col gap-2 items-start`}
        >
          <p className={`text-white flex items-center justify-between text-lg font-medium sm:pe-0 pe-12`}>
            <span>{title}</span>
          </p>
