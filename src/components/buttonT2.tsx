        ...
        return (
            <div className={`w-full flex ${className ? className : 'max-w-sm'}`}>
                <a
                    ...
                    href={`https://chk.eduzz.com/2460920?utm_term=${searchParams.utm_term}&utm_campaign=${searchParams.utm_campaign}&utm_source=FacebookAds-p4&utm_content=${searchParams.utm_content}&utm_medium=${searchParams.utm_medium}`}
